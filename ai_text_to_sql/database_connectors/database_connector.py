...
class DatabaseConnector(ABC):
    ...
    1. Create a new module in the database_connectors directory.
    ...
    6. Add an import statement for the new class in the __init__.py file in the database_connectors directory.
    """
    name = "Base"
